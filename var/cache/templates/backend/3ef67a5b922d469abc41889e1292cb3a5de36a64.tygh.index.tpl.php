<?php /* Smarty version Smarty-3.1.21, created on 2019-08-16 13:02:05
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\index\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5997305385d567f1df296d1-67595563%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '5997305385d567f1df296d1-67595563',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_5d567f1e1c2ab1_20905102',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d567f1e1c2ab1_20905102')) {function content_5d567f1e1c2ab1_20905102($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\function.script.php';
...
"><?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['general_stats']->value['pages']['total_pages']), ENT_QUOTES, 'UTF-8');?>
    ...
    <?php if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\modifier.date_format.php';
...
">
        ...
        <div class="dashboard-row-bottom">
            <div class="dashboard-tables">
                ...
                <?php if ($_smarty_tpl->tpl_vars['user_can_view_orders']->value) {?>
                    <div class="dashboard-table dashboard-table-order-by-statuses" style= "width: 100%; margin-bottom: 30px;">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_status']->value['status_name'], ENT_QUOTES, 'UTF-8');?>
            ...
            <?php if (fn_check_view_permissions("logs.manage","GET")) {?>
                <div class="dashboard-activity" style = "width: 100%;">
...
$_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['link_storefront'] = new Smarty_variable($_tmp3, null, 0);?>
        <?php }?>
