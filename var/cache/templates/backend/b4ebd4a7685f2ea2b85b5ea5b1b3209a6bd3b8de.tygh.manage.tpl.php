<?php /* Smarty version Smarty-3.1.21, created on 2019-08-16 12:48:46
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\orders\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5978058935d567bfe7820c4-82902647%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b4ebd4a7685f2ea2b85b5ea5b1b3209a6bd3b8de' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\views\\orders\\manage.tpl',
      1 => 1550487336,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5978058935d567bfe7820c4-82902647',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d567bfe8aaa08_81513784',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d567bfe8aaa08_81513784')) {function content_5d567bfe8aaa08_81513784($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.hook.php';
...
<?php $_tmp5=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'href'=>"orders.details?order_id=".((string)$_smarty_tpl->tpl_vars['o']->value['order_id']),'text'=>$_tmp5));?>
</li>
...
<?php $_tmp6=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'href'=>"order_management.edit?order_id=".((string)$_smarty_tpl->tpl_vars['o']->value['order_id']),'text'=>$_tmp6));?>
</li>
                    <li><?php ob_start();?><?php echo $_smarty_tpl->__("copy");?>
<?php $_tmp7=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'href'=>"order_management.edit?order_id=".((string)$_smarty_tpl->tpl_vars['o']->value['order_id'])."&copy=1",'text'=>$_tmp7));?>
</li>
...
<?php $_tmp8=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'href'=>"orders.delete?order_id=".((string)$_smarty_tpl->tpl_vars['o']->value['order_id'])."&redirect_url=".((string)$_smarty_tpl->tpl_vars['current_redirect_url']->value),'class'=>"cm-confirm",'text'=>$_tmp8,'method'=>"POST"));?>
</li>
...
<?php $_tmp11=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_tmp11,'dispatch'=>"dispatch[orders.bulk_print]",'form'=>"orders_list_form",'class'=>"cm-new-window"));?>
</li>
            <li><?php ob_start();?><?php echo $_smarty_tpl->__("bulk_print_pdf");?>
<?php $_tmp12=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_tmp12,'dispatch'=>"dispatch[orders.bulk_print..pdf]",'form'=>"orders_list_form"));?>
</li>
            <li><?php ob_start();?><?php echo $_smarty_tpl->__("bulk_print_packing_slip");?>
<?php $_tmp13=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_tmp13,'dispatch'=>"dispatch[orders.packing_slip]",'form'=>"orders_list_form",'class'=>"cm-new-window"));?>
</li>
            <li><?php ob_start();?><?php echo $_smarty_tpl->__("view_purchased_products");?>
<?php $_tmp14=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_tmp14,'dispatch'=>"dispatch[orders.products_range]",'form'=>"orders_list_form"));?>
</li>

            <li class="divider"></li>
            <li class="mobile-hide"><?php ob_start();?><?php echo $_smarty_tpl->__("export_selected");?>
<?php $_tmp15=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_tmp15,'dispatch'=>"dispatch[orders.export_range]",'form'=>"orders_list_form"));?>
</li>
